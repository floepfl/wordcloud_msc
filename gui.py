...
def main_window(font, image):
    ...
    layout = [[sg.Column([[sg.Text('Input image: ', font=font, size=text_size),
                ...
                [sg.Text('Words:', font=font, size=text_size),
                 ...
                 sg.FilesBrowse(font=font, size=(10,1))],
                [sg.Text('Font:', font=font, size=text_size),
                 sg.Input(key='_INPUT_FONT_', default_text='DroidSansMono', font=font),
                 sg.FilesBrowse(font=font, size=(10, 1))],
                [sg.Text('Maximum number of words:', font=font, size=text_size),
                ...
                [sg.Text('Minimum font size:', font=font, size=text_size),
                 sg.Slider(range=(0,500), default_value=4, size=(20,15), orientation='horizontal', font=font, key='_SLIDER_MIN_FONT_')],
                [sg.Text('Maximum font size:', font=font, size=text_size),
                 sg.Slider(range=(0,500), default_value=160, size=(20,15), orientation='horizontal', font=font, key='_SLIDER_MAX_FONT_')],
                [sg.Text('Colormap:', font=font, size=text_size),
                 sg.InputText(font=font, default_text='None', key='_INPUT_COLORMAP_'),
                 sg.Button('See colormaps', key='go_to_colormaps', font=font)],
